                    ...
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-9 ">
                            <form action="shbinsert.se" class="form-group" method="post" enctype="Multipart/form-data">
                                ...
                                <label>작성자</label><br>
                                <input value="${ loginUser.nickname }" name="shbWriter"></input><br><br>
								...
								<label>가격</label>
								<input class="form-control margin-bottom-20" type="text" name="shbPrice">
                                <label>카테고리</label><br>
                                ...
                                <label>게시글</label><br>
                                <textarea style="resize: none; width: 680px; height: 400px;" name="shbContent"></textarea>
                                <hr>
                                <!-- <button class="btn btn-primary " type="#">파일삭제</button>  -->
                                <input type="file" style="display: none;" id="upFilebutton" name="uploadFile">
