                ...
                <div class="panel panel-default" style="margin-top:10px;">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-5">
                                <img itemprop="image"
                                    src="${ contextPath }/resources/srBoardUploadFiles/${ share.renameFileName }"
                                    class="reimg" data-toggle="modal" data-target="#eventModal"
                        ...
                        <p class="pull-center">
                            <button id="end_event" type="button" class="btn btn-danger" onclick="alert('나눔이 종료되었습니다.');"
                                style="display:none; margin: auto;">나눔종료!</button>
                            <button id="join_event" type="button" class="btn btn-color" onclick="alert('댓글로 참여해주세요.');"
                                style="display:none; margin: auto;">나눔진행중</button>
                            <button id="check_event" type="button" class="btn btn-color" onclick="alert('댓글로 참여해주세요.');"
                                style="display:none; margin: auto;">당첨 확인</button>
                        </p>
                        <div class="view-line"></div>
                        ...
                        <p class="pull-center">
                            <button id="shareList" type="button" class="btn btn-color"
                                style="margin: auto; display: block;"
                                onclick="location.href='${ shareList }'">목록으로</button>
                        </p>

                        <div class="view-comment font-18 en" style="margin-top:11px;">
                            <i class="fa fa-commenting"></i> 댓글 : <span id="comment_count"
                                class="orange comment_count"></span> 개
                        </div>
                        <c:if test="${ loginUser != null }">

                            <form action="reply_event_insert.sr" style="display:flex;">
                                <div class="comment-cell" style="width:100%;">
                                    <textarea id="reply_content" tabindex="13" id="wr_content" name="rContent"
                                        maxlength="10000" rows="5" class="form-control input-sm is_cm_color" title="내용"
                                        required style="width: 100%; height:70px;"></textarea>
                                ...
                                <div class="col-md-2" style="display:flex;">
                                    <input type="button" id="reply_insert" value="등록" class="btn btn-success">
                                    <input type="button" id="reply_event_insert" value="등록+신청" class="btn btn-info">
                                </div>
                            </form>
                        </c:if>
