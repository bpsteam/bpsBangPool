            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-9 ">
                            <form class="form-group" action="updateShowing.sb" method="post" enctype="Multipart/form-data">
                                ...
                                <input type="file" id="upFilebutton" style="display:none" name="reloadFile[]"  multiple="multiple"
