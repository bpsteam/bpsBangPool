                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="tabs alternative" >
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <a href="binsert.bo" type="button" class="btn btn-red" style="float: right;">글쓰기</a>
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane fade in" id="sample-3b">
                                        ...
                                        <div class="tabs alternative" >
                                                <ul class="nav nav-tabs">
                                                    <li class="active">
                                                        <a href="#sample-4a" data-toggle="tab">전체</a>
                                                    </li>
                                                    <li>
                                                        <a href="#sample-4a" data-toggle="tab">서울</a>
                                                    </li>
                                                    <li>
                                                        <a href="#sample-4b" data-toggle="tab">인천/부천</a>
                                                    </li>
                                                    <li>
                                                        <a href="#sample-4c" data-toggle="tab">수원/경기</a>
                                                    </li>
                                                    <li>
                                                        <a href="#sample-4d" data-toggle="tab">대구/경북</a>
                                                    </li>
                                                    <li>
                                                        <a href="#sample-4d" data-toggle="tab">부산/경남</a>
                                                    </li>
                                                    <li>
                                                        <a href="#sample-4d" data-toggle="tab">충청/강원</a>
                                                    </li>
                                                    <li>
                                                        <a href="#sample-4d" data-toggle="tab">광주/전라</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div class="tab-pane fade in active" id="sample-4a">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                    ...
                                                    <div class="tab-pane fade in" id="sample-4b">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                    ...
                                                    <div class="tab-pane fade in" id="sample-4c">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                    ...
                                                    <div class="tab-pane fade in" id="sample-4d">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <a href="#" style="float:left" class="btn btn-aqua btn-sm" data-toggle="modal" data-target="#searchModal" onclick="return false;"><i class="fa fa-search"></i></a>
                                                        <button type="button" class="btn btn-red" style="float: right;">글쓰기</button>
                                                    </div>
                                                </div>
