						...
						<div class="at-title" style="width: 950px;">
							<div class="at-container">
								<div class="page-title en">
									<strong> <i class="fa fa-user"></i>마이페이지
									</strong>
								</div>
								<div class="clearfix"></div>
								<div class="page-desc hidden-xs">마이페이지</div>
								<div class="clearfix"></div>
							</div>
						</div>
						<br>
											...
											<div class="panel panel-default view-author">
												...
												<div class="panel-body" style="background-color: white;">
														...
														<div class="pull-left text-center auth-photo"
															...
															<div class="member/profile">
																...
																<a href="mProfile.me" target="_blank" class="win_memo"
																	id="profileInsert" title="사진등록">
																	<div class="photo pull-left">
																		<c:if test="${ empty loginUser.profilerename }">
																			<img src="${ contextPath }/resources/photo.png"
																				style="width: 80px; border-radius: 50px;">
																		</c:if>

																		<c:if test="${ !empty loginUser.profilerename }">
																			<img
																				src="${ contextPath }/resources/profileUpload/${ loginUser.profilerename }"
																				style="width: 80px; border-radius: 50px;">
																		</c:if>
																	</div>
																</a>
                                                   ...
                                                   5 ~ 10 : 골드-->
															...
															<div class="btn-group"
																style="margin-top: -10px; margin-left: -20px; white-space: nowrap;">
																<button type="button"
																	class="btn btn-blue btn btn-primary btn-sm"
																	onclick="apms_like('khajsfirepunch', 'like', 'it_like'); return false;"
																	title="Like">
																	<i class="fa fa-thumbs-up"></i> <span id="it_like">0</span>
																</button>
																<button type="button"
																	class="btn btn-color btn-sm btn btn-red btn btn-primary btn-sm"
																	onclick="apms_like('khajsfirepunch', 'follow', 'it_follow'); return false;"
																	title="Follow">
															...
															<div class="en font-14" style="margin-bottom: 6px;">
																...
																<%-- <c:if
																		...
																		<c:if test="${ mlCode eq 'B' }">
																			<img src="${ contextPath }/resources/lv_basic.png"
																				style="width: 30px;">
																		</c:if> <c:if test="${ mlCode eq 'S' }">
																			<img src="${ contextPath }/resources/lv_silver.png"
																				style="width: 30px;">
																		</c:if> <c:if test="${ mlCode eq 'G' }">
																			<img src="${ contextPath }/resources/lv_gold.png"
																				style="width: 30px;">
																		</c:if>
																</span> ${ loginUser.nickname }
																</span></a></b> &nbsp; <span class="text-muted en font-12"> <c:if
																		test="${ mlCode eq 'B' }">BASIC</c:if> <c:if
																		test="${ mlCode eq 'S' }">SILVER</c:if> <c:if
																		test="${ mlCode eq 'G' }">GOLD</c:if> 레벨
																</span>
															</div>
															<br>
							...
							<div class="row">
								<div class="col-sm-7">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h3 class="panel-title">나의 정보 보기</h3>
										</div>
										<ul class="list-group" style="background-color: white;">
											<!-- <li class="list-group-item"><a
												href="http://myroom.oceanmate.co.kr/bbs/point.php"
												target="_blank" class="win_point"> <span
													class="pull-right">0점</span> MP
											</a></li> -->
											<li class="list-group-item"><span class="pull-right">${ loginUser.phone }</span>
												연락처</li>
											<li class="list-group-item"><span class="pull-right">${ loginUser.email }</span>
												E-Mail</li>
											<li class="list-group-item"><span class="pull-right">${ loginUser.gender }</span>
												성별</li>

											<li class="list-group-item" style="height: 88px"><span
												class="pull-right" style="text-align: right">${ loginUser.address }</span>
												주소</li>
								...
								<div class="col-sm-8">
									<div class="col-xs-3">
										<div class="form-group">
											<a href="mupConfirm.me"
												class="btn btn-green btn-sm btn-block"> 정보수정 </a>
										</div>
									</div>
									<div class="col-xs-3">
										<div class="form-group">
											<button id="deleteMember"
												class="btn btn-red btn-sm btn-block leave-me">탈퇴하기
											</button>
										</div>
									</div>
								</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group has-feedback">
						<label><b>회원아이디 : <span id="mb_confirm_id"
								class="text-primary">${loginUser.email }</span>
						</b></label> <input type="password" name="pwd" id="passwordCheck" required
							class="form-control input-sm" size="15" maxlength="20"> <span
