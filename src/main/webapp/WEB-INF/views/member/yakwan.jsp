        ...
        <div id="content">
            ...
            <input type="hidden" name="pim" value="">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="overflow-y: scroll; height: 200px; background-color: white;" >
                                        <div class="register-term">
            <div class="page-content">
            
                
                <div class="article-title" style="padding-top:0px; overflow:auto;">제1조 목적</div>  
            ...
            <div class="h30"></div>				</div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                                ...
                                <div class="panel-body collapse" id="privacy" style="border-bottom:1px solid #ddd; overflow-y: scroll; background-color: white;">
                            <div class="register-term">
            ...
            <div class="page-content" style="height: 200px;">
                ...
                <ol>
                    ...
                    <ol>
                        <li>개인정보관리책임자 성명 : OOO
                        </li><li>전화번호 : OOO-OOO-OOOO
                        </li><li>이메일 : admin@email.com
                    </li></ol>
            ...
            <div class="h30"></div>				</div>
                            ...
                            <table class="table" style="border-top:0px; background-color: white;">
                        <colgroup>
                            <col width="40%">
                            <col width="30%">
                        </colgroup>
